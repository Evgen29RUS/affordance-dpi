# v5_3_train_sigma010.py
# Identical to v5_3_train.py with SIGMA_C = 0.010.
# Separate checkpoint dir and JSON to preserve sigma_c=0.005 results.
...
GRID      = 8
SIGMA_OBS = 0.200
SIGMA_C   = 0.010            # <-- only physical change
N_ACTIONS = 4
...
CHECKPOINT_DIR = 'v5_3_checkpoints_sigma010'   # <-- separate
RESULT_FILE    = 'v5_3_results_sigma010.json'
SANITY_FILE    = 'v5_3_sanity_sigma010.json'
...
def train(variant, seed, n_steps, verbose=False):
...
def main():
    print("=" * 78)
    print("v5.3 PPO — two-lock symmetric task (SIGMA_C = 0.010)")
    print("=" * 78)
    ...
    if not sanity_ok:
        print("  → STOP. Full run not performed.")
